...
export default function AddEmployee({ setShowModal, fetchEmployees }) {
  ...
  const [selectedDeductions, setSelectedDeductions] = useState([]); // This state holds the actual selected deductions

  // Initialize employee state without directly linking selectedDeductions here
  const [employee, setEmployee] = useState({
    ...
    // selectedDeductions will be added in handleSubmit
  });

  // Use useEffect to update the employee state when selectedDeductions changes
  // This ensures the employee object always has the latest selectedDeductions
  useEffect(() => {
    setEmployee((prevEmployee) => ({
      ...prevEmployee,
      selectedDeductions: selectedDeductions,
    }));
  }, [selectedDeductions]); // Dependency array: run this effect whenever selectedDeductions changes
  ...
  const handleSubmit = async (e) => {
    ...
    // The console.log here will now show the updated employee object including selectedDeductions
    console.log("Submitting Employee Data:", employee);

    try {
      await Server.addEmployee(employee); // Pass the complete employee object
        ...
        >
          ...
          <div className="mb-8">
            ...
            <div>
              ...
              {/* Pass the setter function directly to onSelect */}
